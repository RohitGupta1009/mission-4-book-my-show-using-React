    ...
    return (
        ...
        <div className="flex flex-col-reverse gap-3 lg:gap-5 lg:flex-col">
             ...
             <div className="text-white font-light flex flex-col gap-2 md:px-4">
                ...
                <h4>1h 53m &bull; Action,<span> </span>Adventure,<span> </span>Fantasy  &bull; 13+ </h4>
            </div>


            <div className="flex items-center gap-3 md:px-4 md:w-screen lg:w-full">
            <button className="bg-red-600 lg:w-52 md:w-full w-full py-3 text-white font-semibold rounded-lg">
              Rent ₹149
            </button>
            <button className="bg-red-600 lg:w-52 md:w-full w-full  py-3 text-white font-semibold rounded-lg">
              Buy ₹149
